        ...
        init : function(options) {
            ...
            return this.each(function() {
                ...
                $data.removeQueueItem = function(file, instant, delay) {
                    ...
                    if (file.queueItem) {
                        if (file.queueItem.find('.fileinfo').html() != ' - Completo') {
                        ...
                        if (typeof FormData === 'function' || typeof FormData === 'object') {
                            ...
                            xhr.addEventListener('load', function(e) {
                                if (this.readyState == 4) {
                                    ...
                                    if (this.status == 200) {
                                        if (file.xhr.responseText == '1' || file.xhr.responseText.indexOf("list-group-item") !== -1 ) {
                                        ...
                                        $data.error('UNKNOWN_ERROR', file, uploadAll);
                                    }
                                }
                            });
                    ...
                    if ($.inArray('onError', settings.overrideEvents) < 0) {
                        ...
                        switch(errorType) {
                            ...
                            case 'FILE_SIZE_LIMIT_EXCEEDED':
                                ...
                                break;
                            case 'UNKNOWN_ERROR':
                                errorMsg = 'Erro no upload, tente novamente. (Talvez o arquivo ultrapasse o limite de 100Mb)';
                                break;
                            default:
                                errorMsg = errorType;
                                break;
                ...
                $data.uploadComplete = function(e, file, uploadAll) {
                    if ($.inArray('onUploadComplete', settings.overrideEvents) < 0) {
                        ...
                        file.queueItem.find('.fileinfo').html(' - Completo');
